...
chrome.contextMenus.onClicked.addListener((info, tab) => {
    ...
    if (info.menuItemId === "preencher-formulario-completo") {
        ...
        // Busca o menu pelo id e pega o nome da função
        const menuObj = buscarMenuPorId(MENU_STRUCTURE, info.menuItemId);
        const funcName = menuObj && menuObj.func;
        chrome.scripting.executeScript({
            target: { tabId: tab.id },
            func: function(tipo, funcName, brasilCache) {
                ...
                if (g && typeof g[funcName] === "function") {
                    // Funções que precisam de brasilCache
